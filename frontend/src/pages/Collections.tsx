  ...
  if (isLoading) {
    return (
      <div className="px-4 sm:px-8 py-8 max-w-5xl mx-auto">
        <div className="h-4 w-32 rounded-full bg-surface-raised animate-pulse mb-6" />
        ...
        <div>
          ...
          <h1 className="text-xl font-semibold text-foreground flex items-baseline gap-2">
            ...
            {collections.length > 0 && (
              <span className="text-sm font-normal text-foreground-muted">{collections.length}</span>
            )}
          </h1>
        </div>
        <button
